/*
  ...
  - Added the required column `prefereces` to the `User` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `user` DROP PRIMARY KEY,
    ...
    ADD COLUMN `prefereces` JSON NOT NULL,
